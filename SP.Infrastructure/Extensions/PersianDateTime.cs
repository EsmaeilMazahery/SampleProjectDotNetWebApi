...
namespace System
{
    ...
    public static class PersianDateTimeExtensions
    {
        ...
        {
            return new PersianDateTime(date).ToString();
        }

        public static string ToPersianString(this DateTime date, PersianDateTimeFormat format)
        {
            return new PersianDateTime(date).ToString(format);
        }

        public static string ToPersianShortDateTimeString(this DateTime date)
        {
            return date.TimeOfDay.ToHHMM() + " - " + new PersianDateTime(date).ToString(PersianDateTimeFormat.Date);
        }

        public static string ToPersianShortDateString(this DateTime date)
        {
            return new PersianDateTime(date).ToString(PersianDateTimeFormat.Date);
        }
    }
