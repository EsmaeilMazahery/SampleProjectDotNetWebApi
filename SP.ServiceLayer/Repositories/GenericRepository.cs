...
namespace SP.ServiceLayer.Services
{
    public interface IGenericRepository<T> where T : class
    {
        ...
        IEnumerable<TRel> Except<TRel, TKey>(IEnumerable<TRel> items, IEnumerable<TRel> other, Func<TRel, TKey> getKeyFunc);
    }
    ...
    public abstract class GenericRepository<T> : IGenericRepository<T> where T : class
    {
        ...
        //public void TryUpdateOneToMany<TRel>(IEnumerable<TRel> oldItems, IEnumerable<TRel> newItems, Func<TRel, TRel,bool> oldCondition, Func<TRel,bool> newCondition)
        //{
        //    foreach (var c in oldItems.Where(w => newItems.Any(a => oldCondition(a,w))))
        //    {
        //        oldItems.Remove(c);
        //    }

        //    foreach (var c in newItems.Where(w => newCondition(w)))
        //    {
        //        oldItems.Add(c);
        //    }
        //}
        ...
        public IEnumerable<TRel> Except<TRel, TKey>(IEnumerable<TRel> items, IEnumerable<TRel> other, Func<TRel, TKey> getKeyFunc)
        {
            return items
